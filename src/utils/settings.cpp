...
Settings::Settings()
{
	...
	registerCVar("critter_sightrange",					20, 1, 1000000, false, "distance a critter can see (10 = 1 worldsize)");
	...
	registerCVar("body_maxbodypartsize",				00, 1, 1000000, false, "maximum size of a critters body part");
